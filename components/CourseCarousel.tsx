...
const courses = {
    design: [
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1611532736597-de2d4265fba3?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
      },
      {
        title: 'UIUX-Design',
        programs: [
      ...
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1628494391268-c9935bc384d5?q=80&w=2030&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
      },
      {
    ...
    art: [
      {
        ...
        image: 'https://plus.unsplash.com/premium_photo-1673514503009-912ffc6ff956?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
      }
    ],
    business: [
      {
      ...
      },
      {
        ...
        image: 'https://plus.unsplash.com/premium_photo-1726704124426-c220031548b2?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
      },
      {
        ...
        image: 'https://plus.unsplash.com/premium_photo-1710961232986-36cead00da3c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fG1lZGlhJTIwYW5kJTIwZW50ZXJ0YWlubWVudHxlbnwwfHwwfHx8MA%3D%3D'
      },
      {
        title: 'Animation-VFX',
        programs: [
          'BBA in Advertising and Marketing'
        ],
        image: 'https://plus.unsplash.com/premium_photo-1684341008757-3b456034e943?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
      }
    ]
  };
...
const CourseSection: React.FC<CourseSectionProps> = ({ courses }) => (
  <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-6 ${poppins.className}`}>
    {courses.map((course, idx) => (
      <Card key={idx} className="overflow-hidden group hover:shadow-2xl transition-all duration-300 border-yellow-100 hover:border-yellow-300">
        ...
        <CardContent className="p-6 bg-white">
          ...
          <ul className="space-y-2">
            {course.programs.map((program, idx) => (
              <li key={idx} className="text-sm text-gray-600 hover:text-yellow-600 transition-colors flex items-start">
...
const CourseCatalog = () => {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-b from-yellow-50 to-white ${poppins.className}`}>
