...
const ApplyNowForm = () => (
  <div className="bg-zinc-900 p-8 mx-3 md:mx-0 rounded-xl">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <input
        ...
        className="bg-zinc-800 border border-zinc-700 rounded-lg p-3 text-white"
      />
      <input
        type="email"
      ...
      <input
        ...
        className="bg-zinc-800 border border-zinc-700 rounded-lg p-3 text-white"
      />
      <select className="bg-zinc-800 border border-zinc-700 rounded-lg p-3 text-white">
      ...
      <textarea
        ...
        className="bg-zinc-800 border border-zinc-700 rounded-lg p-3 text-white md:col-span-2"
        rows={4}
      />
