    ...
    <section className="max-w-7xl mx-auto px-4 py-24">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start mb-12">
        <div className="max-w-3xl">
          <h2 className="text-4xl font-bold text-gray-900 mb-6">Sports Arena</h2>
          <p className="text-lg text-gray-600 leading-relaxed">
            ...
            and a fit body go together. <span className="font-semibold text-gray-900">
            The International Sports Arena – The League</span> has been
            established with an Olympic vision to rouse the champion in
            students, covering a wide array of sporting facilities.
          </p>
        </div>
        <a href="#" className="text-red-500 font-semibold hover:underline mt-4 md:mt-0">
          Read More &gt;
        </a>
      </div>
